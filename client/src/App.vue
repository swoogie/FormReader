...
<template>
    <header class="flex justify-center max-h-screen leading-6">
        <div class="wrapper">
            <HelloWorld :pageTitle="pageTitle" :msg="msg" />
            <nav class="w-full font-medium text-center mt-7">
                <RouterLink class="px-2 duration-150 transition-colors hover:bg-green-400 hover:bg-opacity-50" to="/">Home</RouterLink>
                <RouterLink class="px-2 duration-150 border-l border-gray-500 transition-colors hover:bg-green-400 hover:bg-opacity-50" to="/camera">Camera</RouterLink>
                <RouterLink class="px-2 duration-150 border-l border-gray-500 transition-colors hover:bg-green-400 hover:bg-opacity-50" to="/upload">Upload</RouterLink>
            </nav>
        </div>
    </header>
